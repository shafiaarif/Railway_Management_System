...
<body>
  ...
  <div class="sidebar">
    <h2>Dashboard</h2>
    <a class="nav-link" href="view_user.php"><i class="fas fa-book"></i>View Users</a>
    <a class="nav-link" href="add_station.php"><i class="fas fa-book"></i>Add Station</a>
    <a class="nav-link" href="add_routes.php"><i class="fas fa-user-plus"></i>Add Routes</a>
    <a class="nav-link" href="add_trains.php"><i class="fas fa-user-plus"></i>Add Train</a>
